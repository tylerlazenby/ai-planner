...
import {Task, Plan, Priority} from "@prisma/client"
...
interface PlanDetailProps {
    initialPlan: PlanWithTasks | null
}

export function PlanDetail({ initialPlan }: PlanDetailProps) {
    ...
    if (!plan) {
        return (
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                <h1 className="text-3xl font-bold tracking-tight mb-6">Previous Plan Not Found</h1>
                <Button onClick={() => router.push("/past-plans")} asChild>
                    <Link href={'/past-plans'}>
                    ...
                    <div className="rounded-md border">
                        ...
                        <div className="divide-y">
                            {timeSlots.map((slot, index) => {
                                ...
                                ${task.priority === Priority.HIGH ? "border-l-4 border-l-primary" : ""}
                              `}
                                                            style={{
                                                                minHeight: "58px",
                            ...
                            >
                                <div>
                                    <div className="font-medium flex items-center gap-2">
                                        ...
                                        {task.priority === Priority.HIGH && <Badge variant="outline">Priority</Badge>}
                                    </div>
